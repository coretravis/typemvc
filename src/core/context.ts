...
export function assembleContext(
  ...
  // The model is frozen in place: it is the object the action handed to the view,
  // produced for this render, and it may be a class instance whose prototype a copy
  // would strip.
  ctx.model = Object.freeze(model ?? (Object.create(null) as Record<string, unknown>));
  ctx.data = Object.freeze(
    viewBag !== null
      ? Object.assign(Object.create(null) as Record<string, unknown>, viewBag.getAll())
